...
const DISTRICT_FALLBACKS = {
  ...
  'Kondagaon': `${WMF}c/cd/Tribal_Woman_at_Weekly_Village_Market.jpg`,
  ...
  'Narayanpur': `${WM}c/cd/Abujmarh_%28restricted_area_in_chattisgarh%29.jpg/960px-Abujmarh_%28restricted_area_in_chattisgarh%29.jpg`,
  'Raigarh': `${WM}3/36/Girivilas_Palace.jpg/960px-Girivilas_Palace.jpg`,
  'Sakti': `${WM}3/3c/Maa_Beri_Wali_Mandir.jpg/960px-Maa_Beri_Wali_Mandir.jpg`,
  'Sarangarh-Bilaigarh': `${CTB}mahasamund-2.jpg`,
  'Sukma': `${WM}1/1b/Malkan_giri_Sukma_C.G.jpg/960px-Malkan_giri_Sukma_C.G.jpg`,
...
const ALL_DISTRICTS = [
 { name: 'Raipur', image: `${CTB}001%20(2).jpg`, desc: 'Capital city with modern amenities and vibrant culture', highlights: 'State Capital', coordinates: { lat: 21.2514, lng: 81.6296 }, category: 'urban', touristPlaces: [
  ...
  { name: 'Kondagaon', image: `${WMF}c/cd/Tribal_Woman_at_Weekly_Village_Market.jpg`, desc: 'Tribal crafts capital and gateway to Bastar art', highlights: 'Bastar Crafts', coordinates: { lat: 19.5960, lng: 81.6615 }, category: 'heritage', touristPlaces: [
  ...
  { name: 'Janjgir-Champa', image: `${WM}4/4a/12th-century_Small_and_Large_Vishnu_temples%2C_Janjgir_Chhattisgarh%2C_archive_late_19th_century.jpg/960px-12th-century_Small_and_Large_Vishnu_temples%2C_Janjgir_Chhattisgarh%2C_archive_late_19th_century.jpg`, desc: 'Ancient Shaktipeeth and Mahanadi riverfront heritage', highlights: 'Shaktipeeth Temples', coordinates: { lat: 22.0177, lng: 82.5804 }, category: 'spiritual', touristPlaces: [
  ...
  { name: 'Narayanpur', image: `${WM}c/cd/Abujmarh_%28restricted_area_in_chattisgarh%29.jpg/960px-Abujmarh_%28restricted_area_in_chattisgarh%29.jpg`, desc: 'Remote Abujhmaad heartland with pristine forests', highlights: 'Abujhmaad Forest', coordinates: { lat: 19.6754, lng: 81.0512 }, category: 'nature', touristPlaces: [
  ...
  { name: 'Raigarh', image: `${WM}3/36/Girivilas_Palace.jpg/960px-Girivilas_Palace.jpg`, desc: 'Cultural capital of Chhattisgarh with Chakradhar arts', highlights: 'Kathak Heritage', coordinates: { lat: 21.8974, lng: 83.3950 }, category: 'heritage', touristPlaces: [
  ...
  { name: 'Sakti', image: `${WM}3/3c/Maa_Beri_Wali_Mandir.jpg/960px-Maa_Beri_Wali_Mandir.jpg`, desc: 'Newly formed district with temples and rural heritage', highlights: 'Janjgir Temples', coordinates: { lat: 22.0349, lng: 82.9568 }, category: 'heritage', touristPlaces: [
  ...
  { name: 'Sukma', image: `${WM}1/1b/Malkan_giri_Sukma_C.G.jpg/960px-Malkan_giri_Sukma_C.G.jpg`, desc: 'Remote Bastar with Sabari river and tribal heritage', highlights: 'Sabari River', coordinates: { lat: 18.3918, lng: 81.6634 }, category: 'nature', touristPlaces: [
